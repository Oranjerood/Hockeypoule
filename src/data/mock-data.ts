...
export const TEAMS: Team[] = [
  ...
  { id: "team-w-argentina", competitionId: WK_HOCKEY.id, name: "Argentinië", country: "Argentinië", flagEmoji: "🇦🇷", division: "women" },
  { id: "team-w-australia", competitionId: WK_HOCKEY.id, name: "Australië", country: "Australië", flagEmoji: "🇦🇺", division: "women" },
  { id: "team-w-belgium", competitionId: WK_HOCKEY.id, name: "België", country: "België", flagEmoji: "🇧🇪", division: "women" },
  { id: "team-w-chile", competitionId: WK_HOCKEY.id, name: "Chili", country: "Chili", flagEmoji: "🇨🇱", division: "women" },
  { id: "team-w-china", competitionId: WK_HOCKEY.id, name: "China", country: "China", flagEmoji: "🇨🇳", division: "women" },
  { id: "team-w-england", competitionId: WK_HOCKEY.id, name: "Engeland", country: "Engeland", flagEmoji: "🏴󠁧󠁢󠁥󠁮󠁧󠁿", division: "women" },
  { id: "team-w-germany", competitionId: WK_HOCKEY.id, name: "Duitsland", country: "Duitsland", flagEmoji: "🇩🇪", division: "women" },
  { id: "team-w-india", competitionId: WK_HOCKEY.id, name: "India", country: "India", flagEmoji: "🇮🇳", division: "women" },
  { id: "team-w-ireland", competitionId: WK_HOCKEY.id, name: "Ierland", country: "Ierland", flagEmoji: "🇮🇪", division: "women" },
  { id: "team-w-japan", competitionId: WK_HOCKEY.id, name: "Japan", country: "Japan", flagEmoji: "🇯🇵", division: "women" },
  { id: "team-w-netherlands", competitionId: WK_HOCKEY.id, name: "Nederland", country: "Nederland", flagEmoji: "🇳🇱", division: "women" },
  { id: "team-w-new-zealand", competitionId: WK_HOCKEY.id, name: "Nieuw-Zeeland", country: "Nieuw-Zeeland", flagEmoji: "🇳🇿", division: "women" },
  { id: "team-w-scotland", competitionId: WK_HOCKEY.id, name: "Schotland", country: "Schotland", flagEmoji: "🏴󠁧󠁢󠁳󠁣󠁴󠁿", division: "women" },
  { id: "team-w-south-africa", competitionId: WK_HOCKEY.id, name: "Zuid-Afrika", country: "Zuid-Afrika", flagEmoji: "🇿🇦", division: "women" },
  { id: "team-w-spain", competitionId: WK_HOCKEY.id, name: "Spanje", country: "Spanje", flagEmoji: "🇪🇸", division: "women" },
  { id: "team-w-united-states", competitionId: WK_HOCKEY.id, name: "Verenigde Staten", country: "Verenigde Staten", flagEmoji: "🇺🇸", division: "women" },
  // FIH Hockey World Cup 2026 - Men (16 teams, Poules A-D)
  { id: "team-m-argentina", competitionId: WK_HOCKEY.id, name: "Argentinië", country: "Argentinië", flagEmoji: "🇦🇷", division: "men" },
  { id: "team-m-australia", competitionId: WK_HOCKEY.id, name: "Australië", country: "Australië", flagEmoji: "🇦🇺", division: "men" },
  { id: "team-m-belgium", competitionId: WK_HOCKEY.id, name: "België", country: "België", flagEmoji: "🇧🇪", division: "men" },
  { id: "team-m-england", competitionId: WK_HOCKEY.id, name: "Engeland", country: "Engeland", flagEmoji: "🏴󠁧󠁢󠁥󠁮󠁧󠁿", division: "men" },
  { id: "team-m-france", competitionId: WK_HOCKEY.id, name: "Frankrijk", country: "Frankrijk", flagEmoji: "🇫🇷", division: "men" },
  { id: "team-m-germany", competitionId: WK_HOCKEY.id, name: "Duitsland", country: "Duitsland", flagEmoji: "🇩🇪", division: "men" },
  { id: "team-m-india", competitionId: WK_HOCKEY.id, name: "India", country: "India", flagEmoji: "🇮🇳", division: "men" },
  { id: "team-m-ireland", competitionId: WK_HOCKEY.id, name: "Ierland", country: "Ierland", flagEmoji: "🇮🇪", division: "men" },
  { id: "team-m-japan", competitionId: WK_HOCKEY.id, name: "Japan", country: "Japan", flagEmoji: "🇯🇵", division: "men" },
  { id: "team-m-malaysia", competitionId: WK_HOCKEY.id, name: "Maleisië", country: "Maleisië", flagEmoji: "🇲🇾", division: "men" },
  { id: "team-m-netherlands", competitionId: WK_HOCKEY.id, name: "Nederland", country: "Nederland", flagEmoji: "🇳🇱", division: "men" },
  { id: "team-m-new-zealand", competitionId: WK_HOCKEY.id, name: "Nieuw-Zeeland", country: "Nieuw-Zeeland", flagEmoji: "🇳🇿", division: "men" },
  { id: "team-m-pakistan", competitionId: WK_HOCKEY.id, name: "Pakistan", country: "Pakistan", flagEmoji: "🇵🇰", division: "men" },
  { id: "team-m-south-africa", competitionId: WK_HOCKEY.id, name: "Zuid-Afrika", country: "Zuid-Afrika", flagEmoji: "🇿🇦", division: "men" },
  { id: "team-m-spain", competitionId: WK_HOCKEY.id, name: "Spanje", country: "Spanje", flagEmoji: "🇪🇸", division: "men" },
  { id: "team-m-wales", competitionId: WK_HOCKEY.id, name: "Wales", country: "Wales", flagEmoji: "🏴󠁧󠁢󠁷󠁬󠁳󠁿", division: "men" },
